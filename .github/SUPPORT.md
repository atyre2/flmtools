# Getting help with flmtools

Thanks for using flmtools. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/flmtools/issues) to make sure the 
